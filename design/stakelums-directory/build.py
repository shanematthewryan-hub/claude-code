...
.mast{display:flex;align-items:flex-end;justify-content:space-between;
  border-bottom:1.1mm solid var(--red);padding-bottom:2.2mm;margin-bottom:3.2mm}
.brand{display:flex;align-items:baseline;gap:5mm}
.brand b{font-size:24pt;font-weight:800;letter-spacing:-.018em;color:var(--red);line-height:.95}
.brand span{font-size:15pt;font-weight:600;letter-spacing:.055em;color:var(--ink);text-transform:uppercase}
...
.quick{background:var(--paper);border:.28mm solid var(--line);border-radius:1.6mm;
  padding:2.2mm 2.6mm 2.4mm;margin-bottom:3.2mm;box-shadow:0 .3mm .9mm rgba(16,24,40,.05)}
.quick h1{font-size:7.4pt;font-weight:800;letter-spacing:.13em;text-transform:uppercase;
  color:var(--muted);margin-bottom:1.9mm;display:flex;align-items:center;gap:2.5mm}
...
.tile{background:#F7F8FA;border:.25mm solid var(--line);border-top:1mm solid var(--c);
  border-radius:1.2mm;padding:1.5mm 2mm 1.6mm;display:flex;flex-direction:column;gap:.3mm}
.tile .tl{font-size:6.6pt;font-weight:700;letter-spacing:.075em;text-transform:uppercase;color:var(--muted);
  white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.tile .tn{font-size:17pt;font-weight:800;letter-spacing:-.02em;color:var(--c);line-height:1}
...
.card h2{background:var(--c);color:#fff;font-size:calc(7.9pt*var(--s));font-weight:800;letter-spacing:.085em;
  text-transform:uppercase;padding:calc(1.85mm*var(--s)) 2.6mm calc(1.75mm*var(--s))}
.rows{padding:.4mm 0 .6mm}
.r{display:flex;align-items:baseline;gap:2.4mm;padding:calc(1.02mm*var(--s)) 2.6mm;
...
.nm{font-size:calc(8.1pt*var(--s));font-weight:600;color:#161B21;line-height:1.18;letter-spacing:-.005em}
.em{font-size:calc(6pt*var(--s));font-weight:500;color:#7C838C;line-height:1.15;
  overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.v{display:flex;flex-direction:column;align-items:flex-end;gap:.3mm;flex:none}
.ext{font-size:calc(10.6pt*var(--s));font-weight:800;color:var(--c);line-height:1.1;letter-spacing:-.022em;white-space:nowrap}
.ext.mob{font-size:calc(8.2pt*var(--s));font-weight:700;color:var(--ink);letter-spacing:-.01em}
.ext.mob i{font-style:normal;font-size:calc(5.6pt*var(--s));font-weight:800;letter-spacing:.06em;
  color:#fff;background:var(--muted);border-radius:.7mm;padding:.25mm .8mm;
  margin-right:1.1mm;position:relative;top:-.4mm}

.note{font-size:calc(6.4pt*var(--s));line-height:1.45;color:var(--muted);font-weight:500;
